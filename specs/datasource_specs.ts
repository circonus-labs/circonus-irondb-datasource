...
import IrondbDatasource from '../src/datasource';
import TemplateSrvStub from './lib/template_srv_stub';
import Q from 'q';
import moment from 'moment';

describe('IrondbDatasource', function() {
  let ctx: any = {
    backendSrv: {},
  ...
  beforeEach(function() {
    ...
    ctx.ds = new IrondbDatasource(ctx.instanceSettings, ctx.backendSrv, ctx.templateSrv, ctx.$q);
  });
