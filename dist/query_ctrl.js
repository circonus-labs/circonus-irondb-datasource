                ...
                IrondbQueryCtrl.prototype.getSegments = function (index, prefix) {
                    ...
                    return this.datasource
                        ...
                        var allSegments = lodash_1.default.map(segments.data, function (segment) {
                            ...
                            console.log("escapeRegExp(query) (getSegments): " + JSON.stringify(_this.escapeRegExp(query), null, 2));
                    ...
                    return this.datasource
                        ...
                        if (segments.data.length === 0) {
                            if (path !== '') {
                                ...
                                console.log("this.queryModel.segments (checkOtherSegments): " + JSON.stringify(_this.queryModel.segments, null, 2));
                                _this.segments = _this.segments.splice(0, fromIndex + 1);
                                console.log("this.segments (checkOtherSegments): " + JSON.stringify(_this.segments, null, 2));
                            }
                        }
                        else {
                            lodash_1.default.map(segments.data, function (segment) {
                                ...
                                console.log("escapeRegExp(path) (checkOtherSegments): " + JSON.stringify(_this.escapeRegExp(path), null, 2));
                            ...
                            console.log("this.segments (checkOtherSegments): " + JSON.stringify(_this.segments, null, 2));
                            console.log("this.segments.length (checkOtherSegments): " + JSON.stringify(_this.segments.length, null, 2));
